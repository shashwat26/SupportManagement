...
<title>Regional Person ${person.fname}</title>
</head>
<body>
<%@include file="header.jsp"%>
	<div align="center">
		<h3>${msg}</h3>
		<a
			href="${pageContext.request.contextPath}/resources/imgs/${person.photoName}"
			target="_blank"> <img alt="${person.photoName}"
			src="${pageContext.request.contextPath}/resources/imgs/${person.photoName}"
			width="200px" height="200px">
		</a> <br> Data Uploaded of: ${person.fname} ${person.lname} <br>
			...
			<c:forEach items="${personList}" var="person">
				<tr class="success">
					...
					<td><input type="submit" class="btn btn-info"
						onclick="showRegPerson(${person.id})" value="Show"> <input
						type="submit" class="btn btn-success"
						onclick="editRegPerson(${person.id})" value="Edit"> <input
						type="submit" class="btn btn-danger"
						onclick="confirmDelete(${person.id})" value="Delete"> <input
						type="submit" class="btn btn-primary"
						onclick="changePhoto(${person.id})" value="Change Photo">
					</td>
				</tr>
